	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        echo "<tr><td><img src='../images/$row[product_image]' style='width:50px; height:50px; border:groove #000'></td><td>$row[product_title]</td>
                        <td>$row[product_price]</td>
                        <td>

                        <a class=' btn btn-success' href='productlist.php?product_id=$product_id&action=delete'></a>
                        </td></tr>";
                        }
                      }
